...
- `0x08` - Set when `xgameruntime.dll` is in the same directory as the executable, as is required for GDK titles on the Steam Deck. Requries xgameruntime.lib of GDK 2510+ to be set.
